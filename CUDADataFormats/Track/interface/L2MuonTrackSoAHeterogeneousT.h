#ifndef CUDADataFormats_Track_L2MuonTrackHeterogeneousT_H
#define CUDADataFormats_Track_L2MuonTrackHeterogeneousT_H
...
namespace L2MuonTrack {
  ...
  using TrackSoA = L2MuonTrackSoAHeterogeneousT<maxNumber()>;
  using TrajectoryState = TrajectoryStateSoAT<maxNumber()>;
  using HitContainer = TrackSoA::HitContainer;

}  // namespace pixelTrack

#endif  // CUDADataFormats_Track_L2MuonTrackHeterogeneousT_H
