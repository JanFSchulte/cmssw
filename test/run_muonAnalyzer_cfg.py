...
if len(options.inputFiles) == 0:
    if options.resonance == 'Z':
        ...
        if options.isFullAOD:
            ...
            if options.isMC:
                options.inputFiles.append('/store/mc/Run3Summer22MiniAODv4/JpsiTo2Mu_JpsiPt8_TuneCP5_13p6TeV_pythia8/MINIAODSIM/MUO_POG_130X_mcRun3_2022_realistic_v5-v2/60000/4c7e36bf-a38c-4424-bd34-c006063ef50d.root')
            else:
