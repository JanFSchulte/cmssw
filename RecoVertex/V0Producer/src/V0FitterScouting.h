...
//
/**\class V0FitterScouting V0Fitter.h RecoVertex/V0Producer/interface/V0FitterScouting.h
...
#ifndef RECOVERTEX__V0_FITTER_SCOUTING_H
#define RECOVERTEX__V0_FITTER_SCOUTING_H
...
class dso_hidden V0FitterScouting {
public:
  V0FitterScouting(const edm::ParameterSet& theParams, edm::ConsumesCollector&& iC);
...
private:
  ...
  edm::EDGetTokenT<edm::ValueMap<int> > nTrackerLayersWithMeasurementValueMapToken_;
