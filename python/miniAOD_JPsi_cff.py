...
muon = cms.EDAnalyzer('MuonMiniAODAnalyzer',
           ...
           tagSelection = cms.string("pt()>7"), # string to pass cuts on tag
           ...
           pairMassMax = cms.double(3.7), # max mss of mu pair
           pairDz = cms.double(10.1), #max Dz of mu1,mu2
           RequireVtxCreation = cms.bool(True), # if true kills pairs w/o vtx
