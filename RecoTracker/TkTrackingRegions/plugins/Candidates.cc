...
Candidates::Candidates(const edm::ParameterSet& regPSet, edm::ConsumesCollector& iC) {
  // operation mode
  //
...
void Candidates::fillDescriptions(edm::ParameterSetDescription& desc) {
...
Candidates::Objects Candidates::objects(const edm::Event& iEvent) const {
