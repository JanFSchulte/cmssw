...
hltIter0Phase2L3FromL1TkMuonTrackCutClassifierLowPt = cms.EDProducer("TrackCutClassifier",
    ...
    src = cms.InputTag("hltIter0Phase2L3FromL1TkMuonCtfWithMaterialTracksLowPt"),
    vertices = cms.InputTag("hltPhase2L3FromL1TkMuonTrimmedPixelVerticesLowPt")
)
