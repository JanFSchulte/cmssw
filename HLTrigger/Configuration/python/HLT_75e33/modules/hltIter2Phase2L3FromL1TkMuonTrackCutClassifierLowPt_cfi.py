...
hltIter2Phase2L3FromL1TkMuonTrackCutClassifierLowPt = cms.EDProducer("TrackCutClassifier",
    ...
    src = cms.InputTag("hltIter2Phase2L3FromL1TkMuonCtfWithMaterialTracksLowPt"),
