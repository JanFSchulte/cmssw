...
void IDResultEmbedder<pat::Electron>::setIDVariables(pat::Electron &anElectron, reco::VertexCollection vertices, const double rho) const {
      ...
      if (fabs(anElectron.superCluster()->eta()) < 1.4442){
		...
		passEmHadIso = (anElectron.dr03HcalTowerSumEt() + anElectron.dr03EcalRecHitSumEt()) < (2 + 0.03*sc_et + 0.28*rho);
		passEmHadIso2018 = (anElectron.dr03HcalTowerSumEt() + anElectron.dr03EcalRecHitSumEt()) < (2 + 0.03*sc_et + 0.28*rho);
		...
		passEmHadIso = (anElectron.dr03HcalTowerSumEt() + anElectron.dr03EcalRecHitSumEt()) < (2.5 + std::max(0.,0.03*(sc_et-50)) + 0.28*rho);
		passEmHadIso2018 = (anElectron.dr03HcalTowerSumEt() + anElectron.dr03EcalRecHitSumEt()) < (2.5 + std::max(0.,0.03*(sc_et-50)) + (0.15+0.07*fabs(anElectron.superCluster()->eta()))*rho);
